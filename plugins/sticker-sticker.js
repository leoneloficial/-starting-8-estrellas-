...
if (!img) return conn.reply(m.chat, `《♥︎》 *Por favor, envía una imagen o video para hacer un sticker.*`, m, rcanal)
...
else return conn.reply(m.chat, '《♥︎》 *Por favor, envía una imagen o video para hacer un sticker.*', m, rcanal)
