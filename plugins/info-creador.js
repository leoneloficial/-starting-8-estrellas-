...
let handler = async (m, { conn, usedPrefix, text, args, command }) => {
  ...
  let pp = 'https://qu.ax/oqCij.jpg' // Imagen fija en lugar de la foto de perfil
  ...
  ], m, pp) // Pasamos la imagen a la función
} 
...
async function sendContactArray(conn, jid, data, quoted, options, img) {
...
END:VCARD`.trim()
  ...
  return await conn.sendMessage(jid, {
    ...
    image: { url: img } // Enviamos la imagen en el mensaje
  }, { quoted, ...options })
}