...
const message = users.map((v, index) => `• 「♪ ${index + 1} 」\[🌨] Wa.me/${v.user.jid.replace(/[^0-9]/g, '')}?text=${usedPrefix}estado\n[🌟] *Usuario*: ${v.user.name || 'Sub-Bot'}\n[🍓] *Online*: ${ v.uptime ?
> Sub-Bot Power By Starting
 convertirMsADiasHorasMinutosSegundos(Date.now() - v.uptime) : 'Desconocido'}`).join('\n\n\n\n');
...
📌 ⌜ ¿Quieres agregar un sub-bot a tu grupo? ⌟
